...
analysisimage_image_1 = PhotoImage(file= os.path.join(absolute_path,"analysis/image_1.png"))
analysisbutton_image_1 = PhotoImage(file= os.path.join(absolute_path,"analysis/button_1.png"))
analysisbutton_image_2 = PhotoImage(file= os.path.join(absolute_path,"analysis/button_2.png"))
analysisbutton_image_3 = PhotoImage(file= os.path.join(absolute_path,"analysis/button_3.png"))

analysis_failures_image1 = PhotoImage(file = os.path.join(absolute_path,"analysis/analysis_failures/image_1.png"))
analysis_failures_button1 = PhotoImage(file = os.path.join(absolute_path,"analysis/analysis_failures/button_1.png"))
analysis_failures_button2 = PhotoImage(file = os.path.join(absolute_path,"analysis/analysis_failures/button_2.png"))
analysis_failures_button3 = PhotoImage(file = os.path.join(absolute_path,"analysis/analysis_failures/button_3.png"))

analysis_other_image1 = PhotoImage(file = os.path.join(absolute_path,"analysis/analysis_others/image_1.png"))
analysis_other_button1 = PhotoImage(file = os.path.join(absolute_path,"analysis/analysis_others/button_1.png"))
analysis_other_button2 = PhotoImage(file = os.path.join(absolute_path,"analysis/analysis_others/button_2.png"))
analysis_other_button3 = PhotoImage(file = os.path.join(absolute_path,"analysis/analysis_others/button_3.png"))

reimportimage_image_1 = PhotoImage(file = os.path.join(absolute_path,"reimport/image_1.png"))
reimportimage_image_2 = PhotoImage(file = os.path.join(absolute_path,"reimport/image_2.png"))
reimportimage_image_3 = PhotoImage(file = os.path.join(absolute_path,"reimport/image_3.png"))

reimportbutton_image_1 = PhotoImage(file = os.path.join(absolute_path,"reimport/button_1.png"))
reimportbutton_image_2 = PhotoImage(file = os.path.join(absolute_path,"reimport/button_2.png"))
reimportbutton_image_3 = PhotoImage(file = os.path.join(absolute_path,"reimport/button_3.png"))
